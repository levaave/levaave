    ...
    <>
      {activeTokenData ? (
        <div className="table-positions">
          <div className="table-positions-label">
            Positions
          </div>
              ...
              {activeTokenData.map((tokenData, index) => {
                return (
                  <tr>
                    ...
                    <td><button className="close-position-button">Close</button></td>
                  </tr>
                );
              })}
            </tbody>
