  ...
  return (
    <Layout>
      ...
      <Header className="header-levaave">
        ...
        <div style={{ display: 'flex'}}>
          {web3Modal && web3Modal.cachedProvider && <button className="connect-button address" onClick={loadWeb3Modal}>
            {address.slice(0,7)}...{address.slice(address.length - 4)}
          </button>}
          {(web3Modal && web3Modal.cachedProvider) ?<button className="connect-button logout" onClick={logoutOfWeb3Modal}>
              Logout
          </button>:
          ...
          <div className="main-div">
            ...
            <div className="swap-page-header-div">
              <div className="swap-page-header">
                <div className="swap-page-header-text"> LevAave Swap </div>
                    ...
                    <div className="swap-page-input-body">
                      ...
                      <button id="collateral-token-dd" className="swap-page-input-body-button">
                        <span className="swap-page-input-body-button-main-span">
                          <img className="swap-page-input-body-button-img" src={tokenDataJson[selectedCollateralCurrencyType.label].logo}></img>
                  ...
                  <div className="swap-page-input-div">
                    ...
                    <div className="swap-page-input-body">
                      ...
                      <button id="leverage-token-dd" className="swap-page-input-body-button">
                        <span className="swap-page-input-body-button-main-span">
                          <img className="swap-page-input-body-button-img" src={tokenDataJson[selectedLeverageCurrencyType.label].logo}></img>
